...
def compile_rows(raw,price=100,supply_count=100):
    ...
    for line in raw.decode('gb18030').splitlines():
        ...
        # CUIShopBuy::sub_83F020 passes +0x53 to sub_83D330, whose type 0
        # branch disables rbpBuy. Type 1 checks the unsigned level at +0x0D;
        # zero is the explicit no-level-gate policy for this local test shop.
        record[83]=1
